...
<h3>Objective</h3>
            <p>In this section, we will walk through two practical examples in HTML code that use the <pre class="tag-highlight">&lt;hr /&gt;</pre> and <pre class="tag-highlight">&lt;br /&gt;</pre> tags.</p>
            <!--<p>

<section class="overview-yellow">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-lesson"><!-- main section for main content -->
            <p>Welcome to the SimplyCoding Web Development Foundations course! This class is designed to guide you through the essentials of web development, covering topics from basic <b>HTML</b> and <b>CSS</b> to advanced <b>JavaScript</b> techniques. By the end of the course, you will earn three certifications in coding: <b>HTML</b>, <b>CSS</b>, and <b>Front-End Web Development</b>.</p>
            <!--<p>

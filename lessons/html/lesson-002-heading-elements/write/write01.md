<section class="info-blue">
    ...
    <div class="main-wrapper">
        ...
        <div class="content-lesson">
            ...
            <p>
            <ol>
                <li>In the sample code above (and in the Editor Pane on the right), you can see how each heading level appears on the page, noting that <pre class="tag-highlight">&lt;h1&gt;</pre> is the largest and most prominent, while <pre class="tag-highlight">&lt;h6&gt;</pre> is the smallest.</li>
                <li>Understand the importance of maintaining a logical order when using headings to create a clear content structure.</li>
            </ol>
            </p>

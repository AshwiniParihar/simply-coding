    ...
    <div class="main-wrapper">
        ...
        <div class="content-lesson"><!-- main section for main content -->
            ...
            <ul style="list-style: disc">
                <li>Recap the importance of the paragraph element in structuring text on a webpage.</li>
                <li><strong>Practice</strong> using the <pre class="tag-highlight">&lt;p&gt;</pre> tag by creating more articles or blog posts with varied content.</li>
                <li>Highlight the usefulness of placeholder text in web design and how it helps maintain focus on design elements rather than content.</li>
                <li><stong>Experiment</stong> with different text generators to add creativity and fun to their projects.</li>
            </ul>
        </div>
        <!-- Comment out sections you don't want -->
